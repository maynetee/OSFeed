...
import { RefreshCw, Radio, Sparkles, AlertTriangle, ArrowUp } from 'lucide-react'
...
export function FeedPage() {
  ...
  const handleTranslation = useCallback(
    (update: TranslationUpdate) => {
      ...
      queryClient.setQueryData<FeedQueryData>(
        [
          'messages',
          activeChannelIds,
          dateRange,
        ...
        <AnimatePresence>
          {showScrollTop && (
            <motion.button
              ...
              className="fixed bottom-6 right-6 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg hover:bg-primary/90"
