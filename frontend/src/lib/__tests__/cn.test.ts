...
describe('cn', () => {
  ...
  it('should handle dark mode classes', () => {
    ...
    expect(cn('bg-white dark:bg-black', 'dark:bg-gray-900')).toBe('bg-white dark:bg-gray-900')
  })
  ...
  it('should work with common component patterns', () => {
    ...
    expect(cn(baseButton, isDisabled && 'opacity-50 cursor-not-allowed')).toBe(baseButton)
  })
